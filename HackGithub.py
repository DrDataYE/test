...
if __name__ == "__main__":
    ...
    parser.add_argument("--token", default="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", help="التوكن الخاص بـ GitHub")
